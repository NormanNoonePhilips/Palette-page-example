...
async function loadData() {
    ...
    const palRes = await fetch('json/main-palette.json');
    ...
    const rampNames = [
        "purple_night", "wine_glow", "teal_glow", "ocean", "forest",
        "aurora", "dusk", "ember", "deep_space", "slate_mist",
        "cold_fire", "poison", "nebula"
    ];
